...
model.add(tf.keras.layers.GRU(units=64, return_sequences=True, input_shape=(None, num_x_signals,)))
...
model.fit(generator, epochs=40, steps_per_epoch=100, validation_data=validation_data, callbacks=callbacks)
